...
const places = [
    {category: '北海道', name: '札幌・新札幌・琴似'},
    {category: '北海道', name: '大通公園・時計台・狸小路'},
    {category: '北海道', name: 'すすきの・中島公園'},
    ...
    {category: '東京都', name: '東京駅・銀座・秋葉原・東陽町・葛西'},
    {category: '東京都', name: '新橋・汐留・浜松町・お台場'},
    {category: '東京都', name: '赤坂・六本木・霞ヶ関・永田町'},
    {category: '東京都', name: '渋谷・恵比寿・目黒・二子玉川'},
    {category: '東京都', name: '品川・大井町・蒲田・羽田空港'},
    {category: '東京都', name: '新宿・中野・荻窪・四谷'},
    {category: '東京都', name: '池袋・赤羽・巣鴨・大塚'},
    {category: '東京都', name: '東京ドーム・飯田橋・御茶ノ水'},
    {category: '東京都', name: '上野・浅草・錦糸町・新小岩・北千住'},
    ...
    {category: '愛知県', name: '名古屋駅・伏見・丸の内'},
    {category: '愛知県', name: '栄・錦・名古屋城'},
    {category: '愛知県', name: '金山・熱田・千種・ナゴヤドーム'},
    ...
    {category: '京都府', name: '京都駅'},
    {category: '京都府', name: '嵐山・嵯峨野・太秦・高雄'},
    {category: '京都府', name: '河原町・四条烏丸・二条城・御所'},
    {category: '京都府', name: '祇園・東山・北白川'},
    {category: '京都府', name: '大原・鞍馬・貴船'},
    ...
    {category: '大阪府', name: '大阪駅・梅田・ユニバーサルシティ・尼崎'},
    {category: '大阪府', name: 'なんば・心斎橋・天王寺・阿倍野・長居'},
    {category: '大阪府', name: '京橋・淀屋橋・本町・ベイエリア・弁天町'},
    {category: '大阪府', name: '新大阪・江坂'},
